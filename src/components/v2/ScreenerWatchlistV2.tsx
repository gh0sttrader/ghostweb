...
interface ScreenerWatchlistProps {
    className?: string;
    onSymbolSelect: (symbol: string) => void;
    selectedSymbol: string | null;
}

// Using a different slice of data to simulate a "screener" result
const screenerStocks = initialMockStocks.slice(10, 25).sort((a,b) => b.changePercent - a.changePercent);
...
export const ScreenerWatchlistV2: React.FC<ScreenerWatchlistProps> = ({ className, onSymbolSelect, selectedSymbol }) => {
    return (
